...
const logPersonConst = function (person) {console.log("The person is " + person)};
people.forEach(logPersonConst);
...
const logPersonConstArrow = (person)  => console.log("The person is " + person);

people.forEach(logPersonConstArrow);
